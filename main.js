...
inp.addEventListener('input', ()=>{
    let val = inp.ariaValueMax.toLocaleLowerCase()
    const name = document.querySelector('.kolya')
    name.forEach((item)=>{
if(item.lastElementChild.textContent.toLocaleLowerCase().includes(val)){
